...
class LandSetting {
	...
	public function writeToDb(){
		...
		if (isset($this->id)){ //l'id è settato, faccio l'update
			$query="UPDATE config_landsettings SET
							type='{$this->type}',
							var_name='{$this->var_name}',
							value='{$this->value}',
							description='{$this->description}'
...
class LandSettingsList {
	...
	public function loadSettings(){
		...
		while($config_row=mysql_fetch_array($config_load_result)){
			$tmpSetting=new LandSetting($config_row);
			$this->SettingsList[$tmpSetting->getId()]=$tmpSetting;
		}
