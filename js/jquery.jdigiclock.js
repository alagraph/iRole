...
(function($) {
    $.fn.extend({
        ...
        jdigiclock: function(options) {
            ...
            return this.each(function() {
                ...
                html    += '<p id="left_arrow"><img src="images/jdigiclock/icon_left.png" /></p>';
                html    += '<p id="right_arrow"><img src="images/jdigiclock/icon_right.png" /></p>';
                ...
                var next = function() {
                    ...
                    $('#plugin_container > div').filter(function(i) {
                        $(this).stop().animate({'left': (i * 500) - 500 + 'px'}, 400, function() {
                            if (i == 0) {
                ...
                var prev = function() {
                    ...
                    $('#plugin_container > div').filter(function(i) {
                        $(this).stop().animate({'left': i * 500 + 'px'}, 400, function() {
    ...
    $.fn.getWeather = function(el) {
        ...
        $.getJSON(proxy + '?location=' + el.weatherLocationCode + '&metric=' + el.weatherMetric, function(data) {
            ...
            el.find('#forecast_container').append('<div id="update"><img src="images/jdigiclock/refresh_01.png" alt="reload" title="reload" id="reload" />' + el.timeUpdate + '</div>');
